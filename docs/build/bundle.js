...
var app = (function () {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$7, 23, 2, 565);
    			attr_dev(button1, "class", "svelte-13ailmo");
    			add_location(button1, file$7, 24, 2, 627);
    			attr_dev(button2, "class", "svelte-13ailmo");
    			add_location(button2, file$7, 25, 2, 691);
    			attr_dev(div, "class", "svelte-13ailmo");
    			add_location(div, file$7, 22, 0, 557);
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["duration", "currentKeyframe", "keyframeCount", "isEnabled"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("keyframeCount" in $$props) $$invalidate(4, keyframeCount = $$props.keyframeCount);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*isEnabled, $elapsed, duration*/ 41) {
    			if (isEnabled) $$invalidate(2, currentKeyframe = Math.floor($elapsed / duration));
    		}

    		if ($$self.$$.dirty & /*currentKeyframe, keyframeCount*/ 20) {
    ...
    const file$6 = "src/Chart.Bar.svelte";
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "style", div_style_value = "" + (/*barColor*/ ctx[1] + " " + /*transform*/ ctx[2] + " " + /*width*/ ctx[0] + " " + /*height*/ ctx[3]));
    			attr_dev(div, "class", "svelte-18ofpc0");
    			add_location(div, file$6, 19, 0, 498);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*barColor, transform, width, height*/ 15 && div_style_value !== (div_style_value = "" + (/*barColor*/ ctx[1] + " " + /*transform*/ ctx[2] + " " + /*width*/ ctx[0] + " " + /*height*/ ctx[3]))) {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("barColor" in $$props) $$invalidate(1, barColor = $$props.barColor);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$scales, value*/ 576) {
    			$$invalidate(0, width = $scales.x(value) || 0);
    		}

    		if ($$self.$$.dirty & /*$scales, rank, $dimensions*/ 2688) {
    			$$invalidate(10, y = ($scales.y(rank) || 0) + $dimensions.barMargin / 2);
    		}

    		if ($$self.$$.dirty & /*fill*/ 256) {
    			$$invalidate(1, barColor = `--bar-color: ${fill}88;`);
    		}

    		if ($$self.$$.dirty & /*y*/ 1024) {
    			$$invalidate(2, transform = `transform: translateY(${y}px);`);
    		}

    		if ($$self.$$.dirty & /*width*/ 1) {
    			$$invalidate(0, width = `width: ${width - borderWidth}px;`);
    		}
    ...
    function create_each_block$2(key_1, ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	let if_block = /*rank*/ ctx[5] < /*maxRank*/ ctx[0] && create_if_block$3(ctx);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$data, colors, colorCount, maxRank*/ 11) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	return [maxRank, $data, data, colorCount];
    }

    class Chart_Bars extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { maxRank: 0 });
    		...
    		if (/*maxRank*/ ctx[0] === undefined && !("maxRank" in props)) {
    			console.warn("<Chart_Bars> was created without expected prop 'maxRank'");
    		}
    	}
    ...
    const file$5 = "src/Chart.Tick.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "line svelte-1q1fxp2");
    			add_location(div0, file$5, 16, 2, 361);
    			attr_dev(p, "class", "value svelte-1q1fxp2");
    			add_location(p, file$5, 17, 2, 388);
    			attr_dev(div1, "class", "tick svelte-1q1fxp2");
    			set_style(div1, "transform", "translate(" + /*x*/ ctx[0] + "px, 0)");
    			add_location(div1, file$5, 11, 0, 260);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$scales, ticks*/ 3) tick_1_changes.x = /*$scales*/ ctx[0].x(/*value*/ ctx[4]);
    			if (dirty & /*ticks*/ 2) tick_1_changes.value = /*value*/ ctx[4];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:0) {#each ticks as value (value)}",
    		ctx
    	});
    ...
    const file$4 = "src/Chart.Label.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p1, file$4, 22, 4, 538);
    			attr_dev(div0, "class", "inner svelte-14uk05u");
    			add_location(div0, file$4, 20, 2, 479);
    			...
    			add_location(div1, file$4, 16, 0, 388);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/Chart.Labels.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(10:2) {#each $data as { value, rank }",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 8, 0, 171);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*date*/ 1) {
    			$$invalidate(1, year = new Date(date).getFullYear());
    		}
    	};
    ...
    function create_if_block(ctx) {
    	...
    	bars = new Chart_Bars({ props: { maxRank }, $$inline: true });
    	axis = new Chart_Axis({ $$inline: true });
    	labels = new Chart_Labels({ props: { maxRank }, $$inline: true });
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("frameIndex" in $$props) $$invalidate(7, frameIndex = $$props.frameIndex);
    		if ("frame" in $$props) $$invalidate(8, frame = $$props.frame);
    		if ("keyframeDate" in $$props) $$invalidate(4, keyframeDate = $$props.keyframeDate);
    		if ("keyframeData" in $$props) $$invalidate(9, keyframeData = $$props.keyframeData);
    		if ("width" in $$props) $$invalidate(10, width = $$props.width);
    		if ("height" in $$props) $$invalidate(11, height = $$props.height);
    		if ("barHeight" in $$props) $$invalidate(12, barHeight = $$props.barHeight);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*currentKeyframe*/ 4) {
    			$$invalidate(7, frameIndex = Math.min(currentKeyframe, keyframeCount - 1));
    		}

    		if ($$self.$$.dirty & /*frameIndex*/ 128) {
    			$$invalidate(8, frame = keyframes[frameIndex]);
    		}
    		...
    		if ($$self.$$.dirty & /*frame*/ 256) {
    			$$invalidate(4, keyframeDate = frame[0]);
    		}

    		if ($$self.$$.dirty & /*frame*/ 256) {
    			$$invalidate(9, keyframeData = frame[1]);
    		}

    		if ($$self.$$.dirty & /*figureWidth*/ 1) {
    			$$invalidate(10, width = figureWidth);
    		}

    		if ($$self.$$.dirty & /*figureHeight*/ 2) {
    			$$invalidate(11, height = figureHeight);
    		}

    		if ($$self.$$.dirty & /*height*/ 2048) {
    			$$invalidate(12, barHeight = height / maxRank - barMargin);
    		}

    		if ($$self.$$.dirty & /*keyframeData*/ 512) {
    		...
    		if ($$self.$$.dirty & /*width, height, barHeight*/ 7168) {
    		...
    		if ($$self.$$.dirty & /*$xMax, $dimensions*/ 49152) {
    			scales.set({
    				...
    				y: linear().domain([0, maxRank]).range([0, $dimensions.height])
    			});
    		}
